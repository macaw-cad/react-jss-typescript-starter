...
module.exports = function generateConfig(configOverrides) {
  ...
  // SvdO: a fixed sitecoreApiHost is not workable when doing Docker deployment.
  // Make it configurable as process.env.REACT_APP_SITECORE_API_HOST. For client bundle this
  // will be set to nothing (resulting in relative p)
